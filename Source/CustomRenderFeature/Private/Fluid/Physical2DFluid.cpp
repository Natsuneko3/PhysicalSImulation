...
void UPhysical2DFluidSolver::PreRenderView_RenderThread(FRDGBuilder& GraphBuilder, FSceneView& InView)
{
	...
	FRDGTextureDesc TempDesc = FRDGTextureDesc::Create2D(PlandFluidParameters.GridSize.Size2D(), PF_FloatRGBA, FClearValueBinding::Black, TexCreate_ShaderResource | TexCreate_UAV | TexCreate_RenderTargetable);
