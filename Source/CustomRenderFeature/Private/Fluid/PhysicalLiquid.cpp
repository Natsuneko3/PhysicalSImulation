...
DECLARE_CYCLE_STAT(TEXT("Rasterize"), STAT_Rasterize, STATGROUP_CustomRenderFeature)
DECLARE_CYCLE_STAT(TEXT("SpawParticle"), STAT_SpawParticle, STATGROUP_CustomRenderFeature)
DECLARE_CYCLE_STAT(TEXT("DrawLiuquidMesh"), STAT_DrawLiuquidMesh, STATGROUP_CustomRenderFeature)
...
{
	Parameter.GravityScale = LiquidSolverParameter.GravityScale;
	Parameter.LifeTime = LiquidSolverParameter.LifeTime;
}
void FPhysicalLiquidSolver::PreRenderView_RenderThread(FRDGBuilder& GraphBuilder, FSceneView& InView)
{
	...
	int CurrentNumParticle = LastNumParticle + FMath::RoundToInt( DeltaTime * LiquidSolverParameter.SpawnRate);
